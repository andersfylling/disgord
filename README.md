...
To use the install script: `wget https://github.com/andersfylling/disgord/raw/develop/disgord.sh && ./disgord.sh` and follow the guide (please use go v1.11 minimum. Note that this sets GO111MODULE=auto only temporary, and you must do so permanently), or you can do it manually:
