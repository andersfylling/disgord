...
func (c *Client) CreateGlobalCommand(ctx context.Context, applicationID Snowflake, command *ApplicationCommand) error {
...
func (c *Client) CreateGuildCommand(ctx context.Context, applicationID Snowflake, guildID Snowflake, command *ApplicationCommand) error {
...
func (c *Client) UpdateCommandGlobal(ctx context.Context, applicationID, commandID Snowflake, command *ApplicationCommand) error {
...
func (c *Client) UpdateCommandGuild(ctx context.Context, applicationID, guildID, commandID Snowflake, command *ApplicationCommand) error {
...
func (c *Client) DeleteCommandGlobal(ctx context.Context, applicationID, commandID Snowflake) error {
	endpoint := fmt.Sprintf("applications/%d/commands/%d", applicationID, commandID)
	req := &httd.Request{
		Endpoint:    endpoint,
		Method:      "DELETE",
...
func (c *Client) DeleteCommandGuild(ctx context.Context, applicationID, guildID, commandID Snowflake) error {
	endpoint := fmt.Sprintf("applications/%d/guilds/%d/commands/%d", applicationID, guildID, commandID)
	req := &httd.Request{
		Endpoint:    endpoint,
		Method:      "DELETE",
